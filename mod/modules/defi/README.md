...
m.serve('api:background')

# Kill the background process when done
m.kill('api:background')
```
...
- Module information: `~/.mod/api/modules/`
- General API data: `~/.mod/api/`
