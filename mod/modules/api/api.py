...
class Api:
    ...
    def mods(self, 
        ...
        progress_bar = m.tqdm(modules, desc=f"Loading modules thread={page}", total=len(modules))
        results = []
        if threads > 1:
    ...
    def mod(self, module:str,  update=False,  content=False, schema = False, public= False, **kwargs):
        ...
        try:
            ...
            m.print(module,m.detailed_error(e), color='red')
        return info
    ...
    def call(self, fn, 
        ...
        return m.fn(fn)(**params, **kwargs)

    def ask(self, text, **kwargs):
        return m.ask(text, **kwargs)
    ...
    def add_module(self, 
        ...
        result =  {"message": f"Module {module['name']} added successfully", "mod": module}
        print('RESULT',result)
        return result
    ...
    def ask(self, text, *extra_text,  **kwargs):
        """
        Ask a question to the mod
        """
        return m.ask(text, *extra_text, **kwargs)
