...
class Dev:
    ...
    def get_prompt(self, **kwargs) -> str:
        ...
        """
        kwargs['goal']=kwargs.get('goal', self.goal)
        kwargs['toolbelt']= kwargs.get('toolbelt', self.toolbelt())
        kwargs['output_format']= kwargs.get('output_format', output_format)
        ...
        for step in range(steps):
            ...
            try:
                ...
                if self.safety:
                    ...
                    if not input_text.lower().startswith('y'):
                        memory.append(f"User aborted execution at step {step}.")
